...
* Parametric model to estimate blurring as surrogate for depth

* Use modern segmentation algorithms such as segment-anything

* Estimate blurring (depth) for each segment separately
...
* Our objective is to find, $\hat{\theta} = \underset{\boldsymbol{\theta}}{\text{argmax}} \ \ \log L(\boldsymbol{\boldsymbol{\theta}}) = \underset{\theta}{\text{argmax}} \ \ \{\log L_h(\boldsymbol{\theta}) + \log L_v(\boldsymbol{\theta})\}$
