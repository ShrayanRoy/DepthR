...
* Most approaches to estimate depth involve **multiple images** of same scene or **hardware based solutions** like light emitters and coded apertures.
...
* We estimate blurring (depth) for each segment separately.
...
```{r ,warning=FALSE,echo=FALSE,out.width='60%',fig.align='center',echo=FALSE,fig.cap= "Figure: Point Spread Function"}
...
* Choice of prior parameter $\sigma$ is playing an important role.
...
* We have considered five sharp images of same size and random patches of different sizes from that.
...
```{r ,warning=FALSE,echo=FALSE,out.width='85%',fig.align='center',echo=FALSE,fig.cap="Figure: Automatic and Manual Segmentation by SAM"}
...
```{r ,warning=FALSE,echo=FALSE,out.width='40%',fig.align='center',echo=FALSE}
