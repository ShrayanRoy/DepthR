...
# Code to convert xaringan slides to pdf maintaining panel set utilities
# This code is from https://www.garrickadenbuie.com/blog/print-xaringan-chromote/
...
#xaringan_to_pdf(location of html file)
