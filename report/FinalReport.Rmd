...
knitr::include_graphics("C:/Users/User/Desktop/Github Projects/DepthR/report/images/1.1.png")
...
```{r plot_2,warning=FALSE,echo=FALSE,out.width='85%',fig.align='center',echo=FALSE,fig.cap="Plot of Local Smoothing of periodogram of both horizontal (top row) and vertical (bottom row) gradients for eight example images in Figure \\ref{fig:plot_1}."}
...
```{r plot_3,warning=FALSE,echo=FALSE,out.width='90%',fig.align='center',echo=FALSE,fig.cap="Plot of ACF and PACF across and along the direction of horizontal gradients of eight test images in Figure \\ref{fig:plot_1}."}
...
knitr::include_graphics("C:/Users/User/Desktop/Github Projects/DepthR/report/images/4.1.png")
```
