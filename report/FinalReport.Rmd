...
# Set custom margins
par(mar = c(3, 3, 1, 1))  # Adjust the margin values as needed
par(oma = c(0, 0, 0, 0))   # Adjust the outer margin values as needed
```
...
```{r plot_2,warning=FALSE,echo=FALSE,out.width='90%',fig.align='center',echo=FALSE,fig.cap="Plot of Local Smoothing of periodogram of both horizontal (top row) and vertical (bottom row) gradients for eight example images in Figure \\ref{fig:plot_1}."}
...
```{r plot_4,warning=FALSE,echo=FALSE,out.width='80%',out.height= '30%',fig.align='center',echo=FALSE,fig.cap="Thin Lens Model of Camera and Circle of Confusion $c_{diam}$ in a given camera setting"}
